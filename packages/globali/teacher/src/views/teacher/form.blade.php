                ...
                <div class="card-body">
                    ...
                    @endif    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $layout=='create' ? old('name') : $teacher->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $layout=='create' ? old('address') : $teacher->address }}" required autocomplete="address" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $layout=='create' ? old('phone') : $teacher->phone }}" required autocomplete="phone" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $layout=='create' ? old('email') : $teacher->email }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nationality" type="text" class="form-control @error('nationality') is-invalid @enderror" name="nationality" value="{{ $layout=='create' ? old('nationality') : $teacher->nationality }}" required autocomplete="nationality" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="post_code" type="number" class="form-control @error('post_code') is-invalid @enderror" name="post_code" value="{{ $layout=='create' ? old('post_code') : $teacher->post_code }}" required autocomplete="post_code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="experience" type="number" class="form-control @error('experience') is-invalid @enderror" name="experience" value="{{ $layout=='create' ? old('experience') : $teacher->experience }}" required autocomplete="experience" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="specialized_subject" class="col-md-4 col-form-label text-md-right">{{ __('Specialized Course') }}</label>
